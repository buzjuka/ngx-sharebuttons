...
var FacebookButton = (function () {
     ...
     * @return {?}
     */
    FacebookButton.prototype.shareUrl = function (mobileType) {
        switch (mobileType) {
...
var TwitterButton = (function () {
    ...
    TwitterButton.prototype.link = function (url, args) {
        var /** @type {?} */ shareUrl = this.shareUrl(args.mobile) + url;
        if (args.description) {
     ...
     * @return {?}
     */
    TwitterButton.prototype.shareUrl = function (mobileType) {
        switch (mobileType) {
            case 'Android': return this.prop.androidUrl;
            case 'iOS': return this.prop.iosUrl;
            default: return this.prop.shareUrl;
...
var WhatsappButton = (function () {
    ...
    WhatsappButton.prototype.link = function (url, args) {
        var /** @type {?} */ shareUrl = this.shareUrl(args.mobile);
        if (args.description) {
     ...
     * @return {?}
     */
    WhatsappButton.prototype.shareUrl = function (mobileType) {
        switch (mobileType) {
            case 'Android': return this.prop.androidUrl;
            case 'iOS': return this.prop.iosUrl;
            default: return this.prop.shareUrl;
...
var GoogleButton = (function () {
    ...
    GoogleButton.prototype.count = function (url) {
        var /** @type {?} */ body = getGoogleBody(url);
        return this.http.post(this.prop.countUrl, body)
            .filter(function (res) { return res[0] && res[0].result && res[0].result.metadata
            && res[0].result.metadata.globalCounts && res[0].result.metadata.globalCounts.count; })
            .map(function (res) { return +res[0].result.metadata.globalCounts.count; })
            .catch(function (err) { return rxjs_Observable.Observable.empty(); });
    };
    return GoogleButton;
}());
...
ShareDirectiveModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                ...
                imports: [
                    ...
                    _angular_common_http.HttpClientJsonpModule
                ],
                exports: [
                    _angular_common.CommonModule,
                    ShareButtonDirective,
